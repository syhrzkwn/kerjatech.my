            ...
            <div class="card p-5 my-5 bg-white">
                <form method="POST" action="{{ route('employer.register.submit') }}">
                    ...
                    <div class="row g-2 mb-4">
                        <div class="col">
                            <a class="btn btn-outline-dark w-100" href="{{route('register')}}">👨🏻‍💻 Freelancer</a>
                        </div>
                        <div class="col">
                            <a class="btn btn-dark w-100" href="{{route('employer.register')}}">🕵🏻‍♀️ Employer</a>
                        </div>
                    </div>
                    ...
                    <div class="form-floating mb-2">
                        <input id="company" type="text" id="floatingInput5" placeholder="Company" class="form-control bg-light @error('company') is-invalid @enderror" name="company" value="{{ old('company') }}" required autocomplete="company">
                        <label for="floatingInput5">Company Name</label>
                    </div>
                ...
                <p class="mt-4 mb-0">Already have an account? <a href="{{ route('employer.login') }}" class="link-dark">Login</a></p>
            </div>
        </div>
    </div>
</div>
