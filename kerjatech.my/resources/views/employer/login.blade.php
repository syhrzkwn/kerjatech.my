            ...
            <div class="card p-3 p-md-5 my-5 bg-white">
                <form method="POST" action="{{ route('employer.login.submit') }}">
                    ...
                    <div class="row g-2 mb-4">
                        <div class="col">
                            <a class="btn btn-outline-dark w-100" href="{{route('login')}}">👨🏻‍💻 Freelancer</a>
                        </div>
                        <div class="col">
                            <a class="btn btn-dark w-100" href="{{route('employer.login')}}">🕵🏻‍♀️ Employer</a>
                        </div>
                    </div>
                ...
                <p class="mt-4 mb-0">Don't have an account? <a href="{{ route('employer.register') }}" class="link-dark">Register</a> now!</p>
            </div>
        </div>
    </div>
</div>
